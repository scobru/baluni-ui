          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="card bg-base-300 shadow-xl">
              <div className="card-body">
                ...
                <div className="card-actions justify-end">
                  <a
                    href="https://github.com/plancia/baluni-cli"
            ...
            <div className="card bg-base-300 shadow-xl">
              <div className="card-body">
                ...
                <p>Sevice used to fetch calldata and others infos</p>
                <div className="card-actions justify-end">
                  <a
                    href="https://github.com/plancia/baluni-api"
                    className="btn btn-primary"
                    target="_blank"
                    rel="noreferrer"
                  >
            ...
            <div className="card bg-base-300 shadow-xl">
              <div className="card-body">
                ...
                <p>Smart contract for route and batch transactions.</p>
                <div className="card-actions justify-end">
                  <a
