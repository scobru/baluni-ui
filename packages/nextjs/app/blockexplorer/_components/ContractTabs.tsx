...
export const ContractTabs = ({ address, contractData }: PageProps) => {
  ...
  useEffect(() => {
    const checkIsContract = async () => {
      const contractCode = await publicClient.getBytecode({ address: address as unknown as any });
  ...
  return (
    <>
      ...
      {activeTab === "storage" && <AddressStorageTab address={address as unknown as any} />}
      {activeTab === "logs" && <AddressLogsTab address={address as unknown as any} />}
    </>
  );
};
